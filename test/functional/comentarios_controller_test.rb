...
class ComentariosControllerTest < ActionController::TestCase
  ...
  test "should create comentario" do
    assert_difference('Comentario.count') do
      post :create, comentario: { asistencia: @comentario.asistencia, comentario: @comentario.comentario, evento: @comentario.evento, id: @comentario.id, nombre: @comentario.nombre }
    end
  ...
  test "should update comentario" do
    put :update, id: @comentario, comentario: { asistencia: @comentario.asistencia, comentario: @comentario.comentario, evento: @comentario.evento, id: @comentario.id, nombre: @comentario.nombre }
    assert_redirected_to comentario_path(assigns(:comentario))
  end
